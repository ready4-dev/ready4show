library(ready4)
x <- ready4fun::make_pkg_desc_ls(pkg_title_1L_chr = "Author Literate Programs Using Markdown To Share Insights From Open, Modular Mental Health Systems Models" %>% tools::toTitleCase(),
