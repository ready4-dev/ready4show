...
methods::setMethod("authorReport", "Ready4showSynopsis", function (x, results_ls = NULL) 
{
    ...
    rmarkdown::render(paste0(paths_ls$path_to_ms_mkdn_dir_1L_chr, 
        ...
        ".Rmd"), output_format = NULL, params = params_ls, output_file = paste0(x@fl_nm_1L_chr, 
        ifelse(x@outp_formats_chr[1] == "Word", ".docx", paste0(".", 
            tolower(x@outp_formats_chr[1])))), output_dir = paths_ls$path_to_ms_outp_dir_1L_chr)
})
