...
#' @slot ms_dir_1L_chr Manuscript directory (a character vector of length one)
...
slots = c(mkdn_data_dir_1L_chr = "character",mkdn_source_dir_1L_chr = "character",ms_mkdn_dir_1L_chr = "character",ms_dir_1L_chr = "character",outp_data_dir_1L_chr = "character",reports_dir_1L_chr = "character",dissemination_1L_chr = "character"),
prototype =  list(mkdn_data_dir_1L_chr = NA_character_,mkdn_source_dir_1L_chr = NA_character_,ms_mkdn_dir_1L_chr = NA_character_,ms_dir_1L_chr = NA_character_,outp_data_dir_1L_chr = NA_character_,reports_dir_1L_chr = NA_character_))
